...
public class ExercisesBean {
    public int id;//每章节习题id
    public String title;//每章节习题标题
    public String content;//每章节习题的数目
    public int background;//每章节习题前边的序号背景
    ...
    public int select;//用户选中的那项（0表示所选项对了，1表示A选项错了，2表示B选项错了，3表示C选项错了，4表示D选项错了)
}
